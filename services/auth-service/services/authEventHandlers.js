...
const handleSendOtp = async (eventData) => {
    try {
        console.log('________________________________handleSendOtp_____________________________________', eventData)
        // const { otp, email } = eventData
        // await sendEmail(email, `Your OTP is ${otp}`);
    } catch (error) {
        console.error('Error while handling the send otp event.')
        throw error;
    }
}
